...
import filemirrorsync.CommandLineParser.CommandLineException;
...
private static String formatDiffs (long[] diffs) {
   return
      "added: "    + diffs[FileSyncProcessor.DiffStatus.add.ordinal()]    + ", " +
...
private static void parseCommandLineArgs (String[] args) {
   ...
   if (sourcePath == null) throw new CommandLineException("Missing source path parameter.");
   if (targetPath == null) throw new CommandLineException("Missing target path parameter."); }

private static void processPositionalParameter (CommandLineParser clp) {
   switch (clp.nextParameterPosition()) {
      case 0: sourcePath = Paths.get(clp.nextArg()); break;
      case 1: targetPath = Paths.get(clp.nextArg()); break;
      default: throw new CommandLineException("Unexpected extra positional parameter on command line."); }}
